...
* [`3`, `3-debian-10`, `3.6.2`, `3.6.2-debian-10-r117`, `latest` (3/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-zookeeper/blob/3.6.2-debian-10-r117/3/debian-10/Dockerfile)
...
The configuration can easily be setup with the Bitnami ZooKeeper Docker image using the following environment variables:
 ...
 - `ZOO_PRE_ALLOC_SIZE`': To avoid seeks ZooKeeper allocates space in the transaction log file in blocks of preAllocSize kilobytes. The default block size is 64M. One reason for changing the size of the blocks is to reduce the block size if snapshots are taken more often. (Also, see snapCount). Default **64000**
